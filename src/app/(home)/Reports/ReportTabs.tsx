          ...
          <div>
            <Link
              ...
              className={`${tab.route==pathname
                ...
                }   capitalize cursor-pointer text-xs md:text-lg py-2 inline-block border-[1px] dark:border-opacity-30 md:border-b-0 md:border-l-[1px] border-[#313131]   md:border-t-[1px] px-4 md:px-8 border-r-[1px]`}>
              {tab.name}
            </Link>
